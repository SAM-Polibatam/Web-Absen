...
<head>
    ...
    <script src="maps/delVal.js"></script>
...
?>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <br>
		<button onclick="window.location.href='AbsenKeluar-report.php'" class='btn btn-success' style="color:white; margin-right: 1%;" id="btnLanjut">Lanjut</a>
                <button onclick="deleteVal(); window.location.href ='Home.php'" class='btn btn-danger' style="color:white;">Kembali</a>
            </div>
    ...
    <!--Google Maps API -->
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=<API-KEY>&callback=init"></script>
</body>
